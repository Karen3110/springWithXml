package com.example.springxml.util;

public class ServiceBeanNames {
    public static final String STUDENT_SERVICE_NAME = "studentService";
    public static final String COURSE_SERVICE_NAME = "courseService";
